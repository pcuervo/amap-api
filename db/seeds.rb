...
if Recommendation.all.count == 0 
  ...
  Recommendation.create(:body => 'Es importante conocer el ppto de los pitches para que tus propuestas vayan alineadas. Verifica esta información con el cliente.', :reco_id => 'agency_budget_3', :reco_type => 'agency')
  ...
  Recommendation.create(:body => 'No todas las agencias invitadas al pitch tienen el PPTO del proyecto definido. Te sugerimos confirmar que compartiste correctamete esta información.', :reco_id => 'client_budget_25', :reco_type => 'client')
  Recommendation.create(:body => 'No todas las agencias invitadas al pitch tienen el PPTO del proyecto definido. Te sugerimos confirmar que compartiste correctamete esta información.', :reco_id => 'client_budget_50', :reco_type => 'client')
  Recommendation.create(:body => 'La mayoría de las agencias participando en tu pitch no tienenel PPTO del proyecto definido. Conocer el presupesto es clave para una mejor propuesta.', :reco_id => 'client_budget_75', :reco_type => 'client')
  Recommendation.create(:body => '¡Ups! Ninguna de las agencias participantes tiene definido el PPTO para el proyecto. Te recomendamos aclarar esta información.', :reco_id => 'client_budget_100', :reco_type => 'client')
